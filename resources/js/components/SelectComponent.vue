<template>
    <div class="row">
        ...
        <div v-if="selectfamilia && selectfamilia.subfamily.length" class="col-md-6 mt-4">
            ...
            <select class="custom-select form-control" v-model="selectsubfamilia"  >
                ...
                <input type="text" class="d-none" name="subfamily_id" :value="selectsubfamilia.id">
            </select>
        </div>
        <div v-if="selectfamilia && selectfamilia.brand.length" class="col-md-6 mt-4">
            ...
            <select class="custom-select form-control" v-model="selectmarca"  >
                ...
                <input type="text" class="d-none" name="marca_id" :value="selectmarca.id">
            </select>
        </div>
        <div v-if="selectmarca && selectmarca.model" class="col-md-6 mt-4">
            ...
            <select class="custom-select form-control" v-model="selectmodelo" >
                ...
                <input type="text" class="d-none" name="modelo_id" :value="selectmodelo.id">
            </select>
        </div>
        <div v-if="selectsubfamilia && selectsubfamilia.serie && selectsubfamilia.serie" class="col-md-6 mt-4">
            <p>Seleccionar Serie</p>
            <select class="custom-select form-control" v-model="selectserie" name="serie_id">
...
<script>
    ...
    export default {
        props:['subfamilias','producto','marcas','familias','modelos','series'],
        // components: {
        //     Multiselect,
        //     Money
        // },
        data(){
          return{
              ...
              selectfamilia: this.producto.family ? this.producto.family : {},
              selectmarca: 0,
              selectmodelo: 0,
              selectserie: 0,
              selectsubfamilia: this.producto.subfamily ? this.producto.subfamily : {},
